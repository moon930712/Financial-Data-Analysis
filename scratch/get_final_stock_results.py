...
def get_final_stock_backtest(start_date, end_date):
    conn = get_connection()
    ...
    # 2. Stock Name Mapping (using distinct from integrated history)
    query_names = "SELECT DISTINCT stock_code, stock_name FROM company.kis_integrated_history"
...
if __name__ == "__main__":
    df_24 = get_final_stock_backtest('2024-01-02', '2025-01-02')
    df_24.to_csv(r'c:\Users\Hubnet\antigravity\results\final_stock_results_2024.csv', index=False, encoding='utf-8-sig')
    
    df_25 = get_final_stock_backtest('2025-01-02', '2025-06-30')
    df_25.to_csv(r'c:\Users\Hubnet\antigravity\results\final_stock_results_2025.csv', index=False, encoding='utf-8-sig')
