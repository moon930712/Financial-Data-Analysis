...
def create_daily_log(title, content):
    ...
    if response.status_code == 200:
        print("[성공] 오늘 하루 한 일 정리가 달력 모드에 영구 기록되었습니다!")
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--content", type=str, default="업종별 Z-Score 모델을 구축하고 노션 API 연동을 마쳤다.", help="Detailed content")
    args = parser.parse_args()
    
    create_daily_log(args.title, args.content)
